const Amount = {
     ...
     */
    inRange: function (amount, min, max) {
        if (!this.isAmount(amount)) {
        ...
        console.log(amount >= this.format2Decimal(min) && amount <= this.format2Decimal(max));
        return amount >= this.format2Decimal(min) && amount <= this.format2Decimal(max);
    },
     ...
     */
    format2Decimal: function (amount) {
        if (amount === undefined) {
            return null;
        }

...
layui.define(['jquery', 'layer', 'form'], function (exports) {
        ...
        cloneObj: function (obj, filter) {
            ...
            for (var key in obj) {
                if (str.indexOf(key) == -1) {
                    var val = obj[key];
                    newObj[key] =
                        typeof val === 'object' ? event.cloneObj(val, typeof filter !== undefined ? filter : []) : val;
                }
            }
            return newObj;
        },
    ...
    DTree.prototype.setting = function (options) {
        ...
        this.accordion =
            typeof this.options.accordion === 'boolean'
                ...
                : typeof OPTIONS.accordion === 'boolean'
                ? OPTIONS.accordion
                : false; //手风琴加载， 默认false
        if (this.accordion) {
        ...
        this.load =
            typeof this.options.load === 'boolean'
                ? this.options.load
                : typeof OPTIONS.load === 'boolean'
                ? OPTIONS.load
                : true; //开启加载动画，默认true
        ...
        this.nodeIconArray =
            $.extend(nodeIconArray, this.options.nodeIconArray || OPTIONS.nodeIconArray) || nodeIconArray; //用户自定义非叶子节点图标集合，node
        this.leafIconArray =
            $.extend(leafIconArray, this.options.leafIconArray || OPTIONS.leafIconArray) || leafIconArray; //用户自定义叶子节点图标集合，leaf
        this.skin = this.options.skin || OPTIONS.skin || 'theme'; // 自定义样式
        if (this.skin == 'layui') {
            // layui主题
            this.line =
                typeof this.options.line === 'boolean'
                    ? this.options.line
                    : typeof OPTIONS.line === 'boolean'
                    ? OPTIONS.line
                    : true; //开启树线，默认开启
            ...
            this.fnodeIcon =
                typeof this.ficon === 'string' || typeof this.ficon === 'number'
                    ? this.ficon == '-1'
                        ? '-1'
                        : '1'
                    : this.ficon[0]; //一级图标中的node节点图标。0：文件夹，1：+、-，2：三角形， -1：不显示一级图标，默认'1'
            this.fleafIcon =
                typeof this.ficon === 'string' || typeof this.ficon === 'number' ? this.ficon : this.ficon[1]; //一级图标中的leaf节点图标
            ...
            this.nodeIcon =
                typeof this.icon === 'string' || typeof this.icon === 'number'
                    ? this.icon == '-1'
                        ? '-1'
                        : '-1'
                    : this.icon[0]; //二级图标中的node节点图标。0：文件夹，1：+、-，2：三角形， -1：不显示二级图标，默认'-1'
            ...
            this.fnodeIcon =
                typeof this.ficon === 'string' || typeof this.ficon === 'number'
                    ? this.ficon == '-1'
                        ? '-1'
                        : '2'
                    : this.ficon[0]; //一级图标中的node节点图标。0：文件夹，1：+、-，2：三角形， -1：不显示一级图标，默认'2'
            this.fleafIcon =
                typeof this.ficon === 'string' || typeof this.ficon === 'number' ? this.ficon : this.ficon[1]; // 一级图标中的leaf节点图标
            this.icon = this.options.icon || OPTIONS.icon || '-1'; //二级图标样式，0：文件夹，1：人员，2：机构，3：报表，4：信息，5：叶子，6：勋章，7：文件，8：小圆点，9：齿轮，10：星星， -1：不显示二级图标。默认'-1'
            this.nodeIcon =
            ...
            this.nodeIcon =
                typeof this.icon === 'string' || typeof this.icon === 'number'
                    ? this.icon == '-1'
                        ? '-1'
                        : '0'
                    : this.icon[0]; //二级图标中的node节点图标。0：文件夹，1：+、-，2：三角形， -1：不显示二级图标，默认'0'
            this.leafIcon = typeof this.icon === 'string' || typeof this.icon === 'number' ? this.icon : this.icon[1]; //二级图标中的leaf节点图标
        }
        ...
        this.async =
            typeof this.options.async === 'boolean'
                ? this.options.async
        ...
        this.checkbarFun =
            $.extend(this.checkbarFun, this.options.checkbarFun || OPTIONS.checkbarFun) || this.checkbarFun; //checkbar事件加载

        /** 菜单栏参数**/
        this.menubar = this.options.menubar || OPTIONS.menubar || false; //是否打开菜单栏
        this.menubarTips =
            $.extend(this.menubarTips, this.options.menubarTips || OPTIONS.menubarTips) || this.menubarTips; //菜单栏吸附， toolbar：依附在工具栏，group：依附在按钮组，freedom，自由
        ...
        this.toolbarStyle =
            $.extend(this.toolbarStyle, this.options.toolbarStyle || OPTIONS.toolbarStyle) || this.toolbarStyle; //toolbar的自定义风格，标题，弹框大小
        ...
        this.iframeFun =
            $.extend(this.iframeFun, this.options.iframeFun) ||
            $.extend(this.iframeFun, OPTIONS.iframeFun) ||
            this.iframeFun; //iframe事件加载
            ...
            this.fnodeIcon =
                typeof this.ficon === 'string' || typeof this.ficon === 'number'
                    ? this.ficon == '-1'
                        ? '-1'
                        : '1'
                    : this.ficon[0]; //一级图标中的node节点图标。0：文件夹，1：+、-，2：三角形， -1：不显示二级图标，默认'1'
            this.fleafIcon =
                typeof this.ficon === 'string' || typeof this.ficon === 'number' ? this.ficon : this.ficon[1]; //一级图标中的leaf节点图标
            ...
            this.fnodeIcon =
                typeof this.ficon === 'string' || typeof this.ficon === 'number'
                    ? this.ficon == '-1'
                        ? '-1'
                        : '2'
                    : this.ficon[0]; //一级图标中的node节点图标。0：文件夹，1：+、-，2：三角形， -1：不显示二级图标，默认'2'
            this.fleafIcon =
                typeof this.ficon === 'string' || typeof this.ficon === 'number' ? this.ficon : this.ficon[1]; //一级图标中的leaf节点图标
            this.icon = this.options.icon || this.icon; //二级图标样式，0：文件夹，1：人员，2：机构，3：报表，4：信息，5：叶子，6：勋章，7：文件，8：小圆点，9：齿轮，10：星星， -1：不显示二级图标。默认'-1'
            this.nodeIcon =
    ...
    DTree.prototype.renderSelectDom = function () {
        ...
        // 设置html
        var prevHtml = [
            '<div class="layui-unselect layui-form-select" dtree-id="' +
                rootId +
                '" dtree-select="' +
                _this.selectDiv +
                '">',
    ...
    DTree.prototype.reloadSelectDom = function () {
        ...
        $("div[dtree-id='" + rootId + "'][dtree-select='" + _this.selectDiv + "']")
            .find('div.layui-select-title')
            .html('');
    ...
    DTree.prototype.useDefaultOrUserDefineFnodeStyle = function (ifont, fnode) {
        ...
        if (typeof fnode === 'undefined') {
            ...
            if (typeof leaf === 'undefined') {
                this.usefontStyle.fnode.leaf =
                    tempLeaf == '' ? ifont + ' ' + this.leafIconArray[this.fleafIcon] : tempLeaf; // 一级图标中的node节点的leaf图标
            } else {
    ...
    DTree.prototype.useDefaultOrUserDefineSnodeStyle = function (ifont, snode) {
        ...
        if (typeof snode === 'undefined') {
            this.usefontStyle.snode.node.open =
                tempOpen == '' ? ifont + ' ' + this.nodeIconArray[this.nodeIcon]['open'] : tempOpen; // 二级图标中的node节点open图标
            ...
            if (typeof leaf === 'undefined') {
                this.usefontStyle.snode.leaf =
                    tempLeaf == '' ? ifont + ' ' + this.leafIconArray[this.leafIcon] : tempLeaf; // 二级图标中的leaf节点图标
            } else {
    ...
    DTree.prototype.useDefaultOrUserDefineMenubarStyle = function (ifont, menubar) {
        ...
        if (typeof menubar === 'undefined') {
            ...
            this.usefontStyle.menubar.checkAll =
                tempCheckAll == '' ? ifont + ' ' + LI_DIV_MENUBAR_CHECKALL : tempCheckAll;
            this.usefontStyle.menubar.unCheckAll =
                tempUncheckAll == '' ? ifont + ' ' + LI_DIV_MENUBAR_UNCHECKALL : tempUncheckAll;
            this.usefontStyle.menubar.invertAll =
                tempInvertAll == '' ? ifont + ' ' + LI_DIV_MENUBAR_INVERTALL : tempInvertAll;
            ...
            if (typeof movedown === 'undefined') {
                this.usefontStyle.menubar.movedown =
                    tempMovedown == '' ? ifont + ' ' + LI_DIV_MENUBAR_DOWN : tempMovedown;
            } else {
            ...
            if (typeof refresh === 'undefined') {
                this.usefontStyle.menubar.refresh =
                    tempRefresh == '' ? ifont + ' ' + LI_DIV_MENUBAR_REFRESH : tempRefresh;
            } else {
    ...
    DTree.prototype.useDefaultOrUserDefineToolbarStyle = function (ifont, toolbar) {
        ...
        if (typeof toolbar === 'undefined') {
            ...
            this.usefontStyle.toolbar.pulldown =
                tempPulldown == '' ? ifont + ' ' + LI_DIV_TOOLBAR_PULLDOWN : tempPulldown;
            ...
            for (var i = 0; i < nowListData.length; i++) {
                ...
                if (childListData.length > 0) {
                    ...
                    _this.loadListTree(
                        ...
                        listData,
                        cLevel,
                        _this.obj.find("ul[data-id='" + parseData.treeId() + "']")
                    );
                }
            }
        }
    ...
    DTree.prototype.parseData = function (data) {
        ...
        return {
            ...
            last: function (len) {
                return len == 0
                    ? typeof data[_this.response.last] === 'boolean'
                        ? data[_this.response.last]
                        : true
                    : typeof data[_this.response.last] === 'boolean'
                    ? data[_this.response.last]
                    : false;
            ...
            spread: function (level) {
                return level < _this.initLevel
                    ? typeof data[_this.response.spread] === 'boolean'
                        ? data[_this.response.spread]
                        : true
                    : typeof data[_this.response.spread] === 'boolean'
                    ? data[_this.response.spread]
                    : false;
    ...
    DTree.prototype.getDom = function (
        ...
        return {
            ...
            checkbox: function () {
                ...
                if (flag) {
                    var result =
                        "<div class='" + LI_DIV_CHECKBAR + "' data-id='" + treeId + "' dtree-id='" + rootId + "'>";
    ...
    DTree.prototype.cancelNavThis = function () {
        ...
        _this.obj
            ...
            .parent()
            .find('.' + NAV_THIS)
            .removeClass(NAV_THIS);
        _this.obj
            .find('div[data-id]')
            .parent()
            .find('.' + _this.style.itemThis)
            .removeClass(_this.style.itemThis);
    };
    ...
    DTree.prototype.checkAllOrNot = function ($i) {
        ...
        if ($i.attr('data-checked') == '1') {
            ...
            // 处理子级节点的选中状态
            var $child_li_i = $child_li.find(
                '>.' + LI_DIV_ITEM + '>.' + LI_DIV_CHECKBAR + ">i[data-type='" + dataType + "']"
            );
            ...
            for (var i = 1, item = $parent_li; i < item.length; i++) {
                ...
                if (flag == 0) {
                    ...
                    var $item_i = item
                        .eq(i)
                        .find('>.' + LI_DIV_ITEM + '>.' + LI_DIV_CHECKBAR + ">i[data-type='" + dataType + "']");
    ...
    DTree.prototype.checkAllOrNoallOrNot = function ($i) {
        ...
        if ($i.attr('data-checked') == '1') {
            ...
            for (var i = 1, item = $parent_li; i < item.length; i++) {
                ...
                var flag2 = item
                    .eq(i)
                    .find('>.' + LI_NAV_CHILD + ' .' + LI_DIV_CHECKBAR + ">i[data-type='" + dataType + "']").length;
                var $item_i = item
                    .eq(i)
                    .find('>.' + LI_DIV_ITEM + '>.' + LI_DIV_CHECKBAR + ">i[data-type='" + dataType + "']");
                if (flag1 != flag2) {
    ...
    DTree.prototype.removeCheckedNode = function () {
        ...
        if (len == 0) {
            ...
            layer.confirm('确定要删除选中节点？', { icon: 3, title: '删除选中节点' }, function (index1) {
                ...
                if (flag) {
                    _this.obj
                        .find("i[data-par][data-checked='1']")
                        .closest('.' + LI_DIV_ITEM)
                        .next('ul')
                        .remove();
                    _this.obj
        ...
        if (_this.menubar && _this.menubarTips.group && _this.menubarTips.group.length > 0)
            _this.obj.before(
                "<div class='" +
                    ...
                    "' id='dtree_menubar_" +
                    _this.obj[0].id +
                    "'><div class='layui-btn-group'></div></div>"
            );
        if (_this.toolbar) {
            if (_this.toolbarWay == 'contextmenu') {
    ...
    DTree.prototype.openTreePlus = function () {
        ...
        if (_this.menubar) {
            ...
            if (group && group.length > 0) {
                ...
                _this.obj
                    .prevAll('div#dtree_menubar_' + _this.obj[0].id)
                    .children('div.layui-btn-group')
                    .append(ggMenu.join(''));
            }
        }
    };
            ...
            case defaultMenu.moveUp:
                _this.toolbarMenu[defaultMenu.moveUp] = _this
                    ...
                    .setMenuToolbarOption(
                        defaultMenu.moveUp,
                        _this.toolbarStyle.title,
                        _this.usefontStyle.toolbar.menubar.moveup,
                        '收缩全部'
                    );
                break;
            case defaultMenu.refresh:
                _this.toolbarMenu[defaultMenu.refresh] = _this
                    ...
                    .setMenuToolbarOption(
                        defaultMenu.refresh,
                        _this.toolbarStyle.title,
                        _this.usefontStyle.toolbar.menubar.refresh,
                        '刷新'
                    );
                break;
            case defaultMenu.checkAll:
    ...
    DTree.prototype.getExtMenubarToolDom = function (menu) {
        ...
        _this.toolbarMenu[menu.menubarId] = _this
            ...
            .setMenuToolbarOption(
                menu.menubarId,
                menu.title,
                _this.usefontStyle.toolbar.menubarExt + ' ' + menu.icon,
                ''
            );
    };
    ...
    DTree.prototype.menubarMethod = function () {
        ...
        return {
            ...
            extMethod: function (menuId, $div, flag) {
                ...
                if (
                    _this.menubar &&
                    _this.menubarTips.toolbar &&
                    _this.menubarTips.toolbar.length > 0 &&
                    flag == 'toolbar'
                ) {
                ...
                if (
                    _this.menubar &&
                    _this.menubarTips.freedom &&
                    _this.menubarTips.freedom.length > 0 &&
                    flag == 'freedom'
                ) {
            ...
            for (var i = 0; i < toolbarShow.length; i++) {
                ...
                if (show == 'pulldown') {
                    _this.toolbarMenu[defaultTool.pulldown] = _this
                        .setToolbarDom()
                        .setToolbarOption(
                            defaultTool.pulldown,
                            _this.toolbarStyle.title,
                            _this.usefontStyle.toolbar.pulldown,
                            '展开'
                        );
                }
                if (show == 'pullup') {
                    _this.toolbarMenu[defaultTool.pullup] = _this
                        ...
                        .setToolbarOption(
                            defaultTool.pullup,
                            _this.toolbarStyle.title,
                            _this.usefontStyle.toolbar.pullup,
                            '收缩'
                        );
                }
                if (show == 'add') {
                    _this.toolbarMenu[defaultTool.addTool] = _this
                        ...
                        .setToolbarOption(
                            defaultTool.addTool,
                            _this.toolbarStyle.title,
                            _this.usefontStyle.toolbar.add,
                            '新增'
                        );
                }
                if (show == 'edit') {
                    _this.toolbarMenu[defaultTool.editTool] = _this
                        ...
                        .setToolbarOption(
                            ...
                            _this.toolbarStyle.title,
                            _this.usefontStyle.toolbar.edit,
                            '编辑'
                        );
                }
                if (show == 'delete') {
                    _this.toolbarMenu[defaultTool.delTool] = _this
                        ...
                        .setToolbarOption(
                            defaultTool.delTool,
                            _this.toolbarStyle.title,
                            _this.usefontStyle.toolbar.del,
                            '删除'
                        );
                }
            }
    ...
    DTree.prototype.toolbarListener = function (tool, $div) {
        ...
        switch (tool) {
            ...
            case defaultTool.delTool:
                layer.confirm(
                    '确定要删除该' + _this.toolbarStyle.title + '？',
                    { icon: 3, title: '删除' + _this.toolbarStyle.title },
                    function (index) {
        ...
        switch (name) {
            case defaultTool.addTool:
                ...
                if (nodeBarContents != null && nodeBarContents.length > 0) {
                    if (
                        nodeBarContents[0] != null &&
                        nodeBarContents[0] != undefined &&
                        nodeBarContents[0].length > 0
                    ) {
            ...
            case defaultTool.editTool:
                ...
                if (nodeBarContents != null && nodeBarContents.length > 0) {
                    if (
                        nodeBarContents[1] != null &&
                        nodeBarContents[1] != undefined &&
                        nodeBarContents[1].length > 0
                    ) {
    ...
    DTree.prototype.loadToolBarDetail = function (nodeBarContents) {
        ...
        return {
            ...
            select: function () {
                var optionsData =
                    typeof nodeBarContents.optionsData === 'object'
                        ? nodeBarContents.optionsData
                        : nodeBarContents.optionsData();
                var options = '';
            ...
            submit: function () {
                ...
                return [
                    '<button type="button" class="layui-btn layui-btn-normal btn-w100" lay-submit lay-filter="' +
                        filter +
                        '" ',
                    id != '' ? 'id="' + id + '" ' : '',
                    name != '' ? 'name="' + name + '" ' : '',
    ...
    DTree.prototype.bindBrowserEvent = function () {
        ...
        _this.obj.on(
            'click',
            "div[dtree-click='" + eventName.itemNodeClick + "'][dtree-disabled='false']",
            function (event) {
                event.stopPropagation();
                var $div = $(this),
                    $cite = $div.find('cite'),
        ...
        if (_this.checkbar) {
            ...
            _this.obj.on(
                'click',
                "i[dtree-click='" + eventName.checkNodeClick + "'][dtree-disabled='false']",
                function (event) {
                    _this.toolbarHide();
                    var $i = $(this),
        ...
        if (_this.menubar) {
            ...
            _this.obj
                .closest('body')
                .find("*[dtree-id='" + _this.obj[0].id + "'][dtree-menu]")
        ...
        if (_this.toolbar) {
            if (_this.toolbarWay == 'contextmenu') {
                ...
                _this.obj.on(
                    ...
                    function (e) {
                        ...
                        _this
                            .setToolbarDom()
                            .setToolbarPlace(
                                _this.toolbarFun.loadToolbarBefore(
                                    event.cloneObj(_this.toolbarMenu),
                                    _this.getRequestParam(node),
                                    $div
                                )
                            );
                ...
                _this.obj
                    .prevAll('div#dtree_toolbar_' + _this.obj[0].id)
                    .on('click', 'a[dtree-tool]', function (event) {
                        event.stopPropagation();
    ...
    $BODY.on('click', function (event) {
        $('div.' + LI_DIV_TOOLBAR)
            .find('.layui-show')
            .removeClass('layui-anim-fadein layui-show');
    ...
    DTree.prototype.unbindBrowserEvent = function () {
        ...
        if (_this.select) {
            // 解绑select的点击事件
            $("div[dtree-id='" + _this.obj[0].id + "'][dtree-select='" + _this.selectDiv + "']").removeClass(
                'layui-form-selected'
            );
